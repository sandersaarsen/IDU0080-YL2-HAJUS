...
public class HinnakiriServiceImpl implements HinnakiriService {
	...
	public GetHinnakiriResponse getHinnakiri(java.lang.String parameters)
		...
		try {
			...
			if (maximumPrice < 0) {
				throw new HinnakiriNumberNegativeFormatException();
			} else if (maximumPrice == 0) {
				throw new HinnakiriNumberZeroFormatException();
			} else if (getFractionDigitsLength(maximumPrice) > 2) {
				throw new HinnakiriNumberDecimalPlacesFormatException();
			}
	...
	private int getFractionDigitsLength(Double maximumPrice) {
		String str = Double.toString(maximumPrice);
